...
export default class MarketPlaceOnboardUpload extends React.Component<IProps, IState> {
    ...
    constructor(props: IProps) {
        ...
        this.state = {
            ...
            steps: [
                {
                    element: ".MarketPlace",
                    intro: "Click here to access market place"
                },
                {
                    element: ".MarketUpload",
                    intro: "Click here to upload your dashboards"
                },
                {
                    element: ".uploadDashboards",
                    intro: "This column will show all your dashboards"
                },
                {
                    element: ".uploadDescriptions",
                    intro: "This column will contain entries so you can enter descriptions for your dashboards"
                },
                {
                    element: ".uploadUpload",
                    intro: "This column contains the button to upload your dashboard to the market"
                },
                {
                    element: ".uploadTable",
                    intro: "Have a go uploading your dashboard"
                },
    ...
    onExit = () => {
        ...
        window.location.href = "/MarketPlaceOnboardBrowse";
    };
